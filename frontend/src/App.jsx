...
function App() {
  ...
  return (
    <div style={{
      ...
      {isLoading && (
          <div style={{ position: 'fixed', top: '5rem', right: '2rem', zIndex: 1000, background: 'rgba(94,106,210,0.2)', padding: '0.5rem 1rem', borderRadius: '20px', backdropFilter: 'blur(5px)', border: '1px solid var(--accent)' }}>
              <span className="fade-in" style={{ fontSize: '0.8rem', fontWeight: 600 }}>Syncing...</span>
          </div>
      )}
